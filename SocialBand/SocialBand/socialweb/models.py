...
class Banda(models.Model):
	...
	ba_picture = models.ImageField(upload_to = 'media/', default = 'media/nopic.jpg')
...
class Evento(models.Model):
	...
	ev_picture = models.ImageField(upload_to = 'media/', default = 'media/nopic.jpg')
...
class MusicLover(models.Model):
	...
	us_picture = models.ImageField(upload_to = 'media/', default = 'media/nopic.jpg')
